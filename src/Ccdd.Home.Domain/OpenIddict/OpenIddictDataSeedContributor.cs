...
namespace Ccdd.Home.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("Home") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "Home", DisplayName = "Home API", Resources = { "Home" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["Home_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["Home_App:RootUrl"]?.TrimEnd('/');
        ...
        //Mobile Client
        var mobileClientId = configurationSection["Home_Mobile:ClientId"];
        if (!mobileClientId.IsNullOrWhiteSpace())
        {
            var mobileClientRootUrl = configurationSection["Home_Mobile:RootUrl"]?.Replace("_", "-");
            await CreateApplicationAsync(
                name: mobileClientId!,
                type: OpenIddictConstants.ClientTypes.Public,
                consentType: OpenIddictConstants.ConsentTypes.Implicit,
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["Home_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["Home_Swagger:RootUrl"]?.TrimEnd('/');
